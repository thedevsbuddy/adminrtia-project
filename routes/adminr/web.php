...
use App\Http\Controllers\Adminr\MailTestController;
...
use App\Http\Controllers\Adminr\RoleAndPermissionController;
...
Route::group(['prefix' => 'adminr', 'as' => 'adminr.'], function () {
    ...
    Route::post('/toggle-permissions', [RoleAndPermissionController::class, 'togglePermission'])->name('roles-and-permissions.toggle-permissions');
    ...
    /// Send test email
    Route::post('/send-test-email', [MailTestController::class, 'send'])->name('send-test-email');
});
